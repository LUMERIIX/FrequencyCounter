...
U 1 1 595E03AA
P 1225 1250
F 0 "#PWR026" H 1225 1100 50  0001 C CNN
...
U 1 1 595E07BC
P 1225 2400
F 0 "#PWR027" H 1225 2150 50  0001 C CNN
...
U 1 1 595E0A75
P 2550 1450
F 0 "#PWR028" H 2550 1200 50  0001 C CNN
...
F 3 "" H 4700 7450 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 9425 4350 2    60   Output ~ 0
EN_CHA_FILTA
Text HLabel 9425 4450 2    60   Output ~ 0
EN_CHA_FILTB
Text HLabel 9425 3500 2    60   Output ~ 0
EN_CHB_FILTA
Text HLabel 9425 3600 2    60   Output ~ 0
EN_CHB_FILTB
...
TMS
Text HLabel 9425 4200 2    60   Input ~ 0
Clk_A
Text HLabel 9425 4000 2    60   Input ~ 0
Clk_B
Text HLabel 9425 4100 2    60   Input ~ 0
Ext_Ref_Clk
NoConn ~ 6250 3450
NoConn ~ 6250 3650
NoConn ~ 6250 4800
...
SDA_DAC
Text GLabel 9700 3900 2    60   Output ~ 0
SCL_DAC
NoConn ~ 3825 3975
NoConn ~ 3825 3875
NoConn ~ 3825 3775
...
U 1 1 5971F636
P 4700 7125
F 0 "#PWR062" H 4700 6975 50  0001 C CNN
...
U 1 1 5971F6C2
P 5600 7125
F 0 "#PWR063" H 5600 6975 50  0001 C CNN
...
U 1 1 5971F74E
P 6650 7125
F 0 "#PWR064" H 6650 6975 50  0001 C CNN
...
U 1 1 5971F9F6
P 7475 3000
F 0 "#PWR065" H 7475 2850 50  0001 C CNN
...
U 1 1 5971FA82
P 6600 3000
F 0 "#PWR066" H 6600 2850 50  0001 C CNN
...
U 1 1 5972013B
P 10500 900
F 0 "#PWR067" H 10500 750 50  0001 C CNN
...
TP1
Text GLabel 2750 3900 2    60   Output ~ 0
TP2
Text GLabel 2750 4000 2    60   Output ~ 0
TP3
Text GLabel 2750 4100 2    60   Output ~ 0
TP4
Text GLabel 2750 4200 2    60   Output ~ 0
TP5
Text GLabel 2750 4325 2    60   Output ~ 0
TP6
Text GLabel 2750 4425 2    60   Output ~ 0
TP7
Text GLabel 2750 4525 2    60   Output ~ 0
TP8
...
U 1 1 5973FE95
P 6350 3000
F 0 "#PWR068" H 6350 2850 50  0001 C CNN
...
U 1 1 5974536A
P 725 6750
F 0 "#PWR069" H 725 6500 50  0001 C CNN
...
U 1 1 597454BF
P 725 6100
F 0 "#PWR070" H 725 5950 50  0001 C CNN
...
U 1 1 59756293
P 3925 4850
F 0 "#PWR071" H 3925 4700 50  0001 C CNN
...
Int_Ref_Clk
Text GLabel 2750 4625 2    60   Output ~ 0
TP9
Text GLabel 2750 4725 2    60   Output ~ 0
TP10
...
U 1 1 59BAB3E9
P 4975 2800
F 0 "#PWR076" H 4975 2550 50  0001 C CNN
...
U 1 1 59BAF83E
P 6300 5025
F 0 "#PWR077" H 6300 4775 50  0001 C CNN
...
U 1 1 59BC3F1E
P 3375 7125
F 0 "#PWR078" H 3375 6975 50  0001 C CNN
...
U 1 1 59C164D1
P 4300 1100
F 0 "#PWR079" H 4300 950 50  0001 C CNN
...
U 1 1 59C16555
P 4700 1300
F 0 "#PWR080" H 4700 1150 50  0001 C CNN
...
U 1 1 59C5CAD1
P 6900 4850
F 0 "#PWR081" H 6900 4700 50  0001 C CNN
...
U 1 1 59DB6246
P 2575 2275
F 0 "#PWR082" H 2575 2025 50  0001 C CNN
